...
public class RcsAdvancedApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("rcs_advanced_api");
	}
	...
	@Test()
	public void verifyRcsAdvancedApi() throws InterruptedException, IOException {

		rcsAdvancedApiPage.openRcsAdvanced("2026-01-01", "2026-01-15");
		rcsAdvancedApiPage.applyAllViewByOptions(fileTitle);

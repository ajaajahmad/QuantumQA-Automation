...
public class RcsSummaryApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("rcs_summary_api");
	}
	...
	public void verifyRcsSummaryPanel() throws InterruptedException, IOException {
		...
		rcsSummaryApiPage.openRcsSummary("01/01/2026 - 01/15/2026");
		rcsSummaryApiPage.applyAllViewByOptions(fileTitle);

...
public class RcsSummaryPanelTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("rcs_summary_panel");
	}
	...
	@Test()
	public void verifyRcsSummaryPanel() throws InterruptedException, IOException {

		rcsSummaryPanelPage.openRcsSummary("01/01/2026 - 01/15/2026");
		rcsSummaryPanelPage.applyAllViewByOptions(fileTitle);

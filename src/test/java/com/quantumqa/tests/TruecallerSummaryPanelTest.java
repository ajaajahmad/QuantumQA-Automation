...
public class TruecallerSummaryPanelTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("truecaller_summary_panel");
	}
	...
	@Test()
	public void verifyTruecallerSummaryPanel() throws InterruptedException, IOException {

		truecallerSummaryPanelPage.openTruecallerSummary("01/01/2026 - 01/15/2026");
		truecallerSummaryPanelPage.applyAllViewByOptions(fileTitle);

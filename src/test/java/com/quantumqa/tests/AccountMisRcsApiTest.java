...
public class AccountMisRcsApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("account_mis_rcs_api");
	}
	...
	@Test()
	public void verifyAccountMisRcsApi() throws InterruptedException, IOException {

		userAccountMisRcsApiPage.openUserAccountMisRcsApi("2026-01-01", "2026-01-15");
		userAccountMisRcsApiPage.applyAllViewByOptions(fileTitle);

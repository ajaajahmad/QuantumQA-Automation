...
public class AccountMisSmsApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("account_mis_sms_api");
	}
	...
	@Test()
	public void verifyAccountMisSmsApi() throws InterruptedException, IOException {

		userAccountMisSmsApiPage.openUserAccountMisSmsApi("2026-01-01", "2026-01-15");
		userAccountMisSmsApiPage.applyAllViewByOptions(fileTitle);

...
public class AccountMisRcsPanelTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("account_mis_rcs_panel");
	}
	...
	@Test()
	public void verifyAccountMisRcsPanel() throws InterruptedException, IOException {

		userAccountMisRcsPanelPage.openUserAccountMisRcsPanel("2026-01-01", "2026-01-15");
		userAccountMisRcsPanelPage.applyAllViewByOptions(fileTitle);

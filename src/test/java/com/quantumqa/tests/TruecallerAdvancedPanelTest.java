...
public class TruecallerAdvancedPanelTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("truecaller_advanced_panel");
	}
	...
	@Test()
	public void verifyTruecallerAdvancedPanel() throws InterruptedException, IOException {

		truecallerAdvancedPanelPage.openTruecallerAdvanced("2026-01-01", "2026-01-15");
		truecallerAdvancedPanelPage.applyAllViewByOptions(fileTitle);

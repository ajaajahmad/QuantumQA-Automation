...
public class AccountMisSmsPanelTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("account_mis_sms_panel");
	}
	...
	@Test()
	public void verifyAccountMisSmsPanel() throws InterruptedException, IOException {

		userAccountMisSmsPanelPage.openUserAccountMisSmsPanel("2026-01-01", "2026-01-15");
		userAccountMisSmsPanelPage.applyAllViewByOptions(fileTitle);

...
public class TruecallerSummaryApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("trucaller_summary_api");
	}
	...
	public void verifyTruecallerSummaryPanel() throws InterruptedException, IOException {
		...
		truecallerSummaryApiPage.openTruecallerSummary("01/01/2026 - 01/15/2026");
		truecallerSummaryApiPage.applyAllViewByOptions(fileTitle);

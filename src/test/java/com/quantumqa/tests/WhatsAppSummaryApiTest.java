...
public class WhatsAppSummaryApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("whatsapp_summary_api");
	}
	...
	public void verifyWhatsAppSummaryPanel() throws InterruptedException, IOException {
		...
		whatsAppSummaryApiPage.openWhatsAppSummary("01/01/2026 - 01/15/2026");
		whatsAppSummaryApiPage.applyAllViewByOptions(fileTitle);

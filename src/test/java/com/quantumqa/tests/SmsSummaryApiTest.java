...
public class SmsSummaryApiTest extends BaseTest {

	private String fileTitle;

	@BeforeTest
	public void generateScreenshotText() {
		fileTitle = DateTimeManager.appendLocalDateTime("sms_summary_api");
	}
	...
	public void verifySmsSummaryPanel() throws InterruptedException, IOException {
		...
		smsSummaryApiPage.openSmsSummary("01/01/2026 - 01/15/2026");
